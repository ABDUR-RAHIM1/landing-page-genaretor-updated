...
const features = [
    {
        ...
        description: "AR Quick Page আপনার ব্যবসার জন্য সবচেয়ে সহজ এবং দক্ষ ল্যান্ডিং পেজ জেনারেটর। এই প্ল্যাটফর্মটি সম্পূর্ণ Responsive, অর্থাৎ মোবাইল, ট্যাবলেট এবং ডেক্সটপে আপনার পেজগুলো সুন্দরভাবে প্রদর্শিত হবে। Mobile-Friendly Design ফিচারটি নিশ্চিত করবে যে যেকোনো ডিভাইসে আপনার পেজ সহজে ব্যবহারযোগ্য হবে।"
    },
    {
        id: 2,
    ...
    {
        id: 9,
        title: "কেন AR Quick Page?",
        icon: <GrFavorite />,
        image: images.home.why,
        description: " AR Quick Page আপনার ব্যবসার সবকিছু সহজে এবং দক্ষভাবে পরিচালনা করতে সহায়ক। এটি আপনার সময়, টাকা এবং প্রচেষ্টাকে আরও কার্যকরভাবে ব্যবহার করতে সাহায্য করবে।"
    }
];
